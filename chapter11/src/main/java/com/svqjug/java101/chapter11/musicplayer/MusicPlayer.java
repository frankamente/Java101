...
public class MusicPlayer {
	...
	public void play(int songPosition) {
        //Look for the song by position in the playlist, set it as current song and play it
	}

	public void previous() {
        //Look for current song position, retrieve the previous one from the playlist and set it as current song
	}

	public void next() {
        //Look for current song position, retrieve the next one from the playlist and set it as current song
    }
